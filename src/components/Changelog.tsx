...
const CHANGELOG_DATA = [
    {
        ...
        changes: [
            { type: "feature", text: "Added !mal plugin — MyAnimeList lookup (search, info, seasonal, watchlist, news)" },
            { type: "feature", text: "Added !primbon plugin — 10 fitur ramalan Primbon (arti nama, mimpi, jodoh, weton, dll)" },
            { type: "feature", text: "Added !yt / !ytmp4 / !ytmp3 plugin — YouTube downloader berbasis youtubei.js v17" },
            { type: "improvement", text: "README diperbarui dengan tabel daftar plugin bawaan" },
        ]
    },
    {
        version: "v2.4.2",
        ...
        changes: [
            { type: "feature", text: "Added !genshin plugin — lookup karakter Genshin Impact lengkap" },
            { type: "feature", text: "Added !wallpaper plugin — wallpaper anime dari WallHaven, ZeroChan, Pinterest, Live2D" },
            { type: "feature", text: "Added !tiktok plugin — downloader video TikTok tanpa watermark" },
            { type: "improvement", text: "Sistem plugin diperluas dengan kategori untuk menu dinamis" },
        ]
    },
    {
        version: "v2.0.0",
