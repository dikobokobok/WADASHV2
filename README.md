...
![WADASH Version](https://img.shields.io/badge/version-2.4.3-blue.svg)
...
|------------|------------------------------------------|---------------------------------------------------------------|
| general    | `!ping`                                  | Cek status bot.                                               |
| general    | `!menu`, `!help`                         | Tampilkan menu fitur.                                         |
| general    | `!checkrole`                             | Cek role pengguna saat ini.                                   |
| sticker    | `!sticker`, `!stiker`, `!s`              | Konversi gambar/video/GIF menjadi sticker WhatsApp.           |
| download   | `!tiktok`, `!tt`, `!ttdl`                | Download video TikTok tanpa watermark.                        |
| download   | `!wallpaper`, `!wp`, `!anime`            | Cari wallpaper anime (WallHaven, ZeroChan, Pinterest, dll).   |
| download   | `!yt`, `!ytmp4`, `!ytmp3`                | Download video atau audio dari YouTube.                       |
| general    | `!genshin`, `!gi`                        | Lookup karakter Genshin Impact (vision, skills, dll).         |
| general    | `!mal`, `!myanimelist`                   | Cari anime, watchlist, berita, dan musiman dari MyAnimeList.  |
| general    | `!primbon`, `!pb`                        | 10 fitur ramalan Primbon (arti nama, mimpi, jodoh, dll).      |
| owner      | `!owner`, `!eval`, `!exec`               | Perintah administratif khusus owner/globOwner.                |
